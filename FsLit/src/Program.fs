...
let private printHelp () =
    ...
    printfn "  // Test: <test objective>   (optional, first line comment)"
    printfn "  // --- Command: <command>"
    printfn "  // --- Input:"
    printfn "  <source code>"
    printfn "  // --- Output:"
    printfn "  <expected output>"
    printfn "  // --- ExitCode: N          (optional, default: not checked)"
    printfn "  // --- Stderr:              (optional, contains-match)"
    printfn "  <expected stderr lines>"
    printfn "  // --- Timeout: N          (optional, seconds)"
    printfn ""
    printfn "Variables:"
    ...
    printfn ""
    printfn "Example:"
    printfn "  // Test: Python addition produces correct output"
